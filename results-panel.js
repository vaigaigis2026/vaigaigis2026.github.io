...
(function () {
  ...
  function buildChartSVG(dataset, opts) {
    ...
    var p = [];
    p.push('<svg viewBox="0 0 ' + width + ' ' + height + '" xmlns="http://www.w3.org/2000/svg" font-family="Arial, Helvetica, sans-serif">');
  ...
  function openModal(dataset) {
    ...
    modalBody.innerHTML = renderChart(dataset, {
      width: isGrouped ? 900 : 800,
      height: isGrouped ? 580 : 480,
      marginLeft: 64, marginRight: 24, marginTop: 50,
      marginBottom: isGrouped ? 110 : 116,
      legendHeight: isGrouped ? 66 : 0,
      titleSize: 19, tickSize: 12.5, valueSize: isGrouped ? 10 : 13,
      catSize: 12, axisTitleSize: 13.5, legendSize: 13,
      catMaxLen: isGrouped ? 28 : 44, maxBarWidth: 66,
