...
(function () {
  ...
  function buildChartSVG(dataset, opts) {
    ...
    var marginBottom = opts.marginBottom || 100;
    var titleSize = opts.titleSize || 15;
    ...
    rows.forEach(function (r, i) {
      ...
      p.push('<text x="' + labelX.toFixed(1) + '" y="' + labelY + '" text-anchor="end" font-size="' + catSize +
        '" fill="' + COL_INK_DIM + '" transform="rotate(-40 ' + labelX.toFixed(1) + ' ' + labelY + ')">' +
  ...
  function buildGroupedChartSVG(dataset, opts) {
    ...
    var marginRight = opts.marginRight || 16;
    var marginTop = opts.marginTop || 40;
    var marginBottom = opts.marginBottom || 90;
    ...
    var plotW = width - marginLeft - marginRight;
    var plotH = height - marginTop - marginBottom - legendHeight;
    ...
    categories.forEach(function (cat, ci) {
      ...
      p.push('<text x="' + labelX.toFixed(1) + '" y="' + labelY + '" text-anchor="end" font-size="' + catSize +
        '" fill="' + COL_INK_DIM + '" transform="rotate(-40 ' + labelX.toFixed(1) + ' ' + labelY + ')">' +
        escapeXml(truncateLabel(String(cat), opts.catMaxLen || 24)) + '</text>');
    });
  ...
  function injectStyles() {
    ...
    style.textContent = [
      ...
      "max-width:1200px;width:100%;max-height:94vh;overflow:auto;box-shadow:0 8px 30px rgba(0,0,0,.5);position:relative;}",
  ...
  function openModal(dataset) {
    ...
    modalBody.innerHTML = renderChart(dataset, {
      width: isGrouped ? 1080 : 980,
      height: isGrouped ? 660 : 580,
      marginLeft: 70, marginRight: 34, marginTop: 54,
      marginBottom: isGrouped ? 150 : 150,
      legendHeight: isGrouped ? 78 : 0,
      titleSize: 20, tickSize: 13, valueSize: isGrouped ? 10.5 : 13.5,
      catSize: 12.5, axisTitleSize: 14, legendSize: 13.5,
      catMaxLen: isGrouped ? 26 : 40, maxBarWidth: 70,
